...
function myFunction(){
    ...
    if(element.style.background==="black"){
        ...
        document.getElementById("readmore").style.background="white";
        document.getElementById("readmore").style.color="black";
        document.getElementById("readmore").style.border="1px solid black";
    }else{
        ...
        document.getElementById("readmore").style.background="black";
        document.getElementById("readmore").style.color="white";
        document.getElementById("readmore").style.border="1px solid white";
    }
